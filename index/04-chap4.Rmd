...
The outcome variable of the OPM data is _Promoted_. One denotes an employee was promoted into the SES position after working year 10, and zero denotes otherwise. In order for analysis result to be consistent, we only include employees with GS or GM pay plan. There are 482 promoted into the SES positions out of 27,932 total employees.
...
Variable Year 10 Grade consists of 7 levels - grade 9 - 15. The proportion of ones for grade 9 to 12 is small, but increases significantly for grade 13 to 15. It is regrouped into three levels - 0 (Grade 9 - 12), 1 (Grade 13 & 14), and 2 (Grade 15). 
...
Year 10 salary is centered on the mean salary at grade 13 from OPM's 2011 pay table (the mean is around \$82,425). Year 10 salary is also scaled by \$10,000 for interpretation purpose. Specifically, denote $x_{i}$ as employee $i$'s year 10 salary, $scale(x_{i}) = \dfrac{x_{i} - 82,425}{10,000}$.
